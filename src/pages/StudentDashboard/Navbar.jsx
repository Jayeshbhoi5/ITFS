...
const Navbar = ({ darkMode, setDarkMode, toggleSidebar, showProfileMenu, toggleProfileMenu, sidebarOpen }) => {
    ...
    <>
      <nav className={`w-full py-4 px-6 flex justify-between items-center sticky top-0 z-40 ${
        ...
        <div className="flex items-center space-x-4">
          <a href="/studentdashboard" className={`${darkMode ? 'text-gray-300 hover:text-blue-400' : 'text-gray-700 hover:text-blue-600'} transition-colors duration-300`}>
            Home
          </a>
